    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form enctype="multipart/form-data" class="forms-sample" method="post" action="{{url('/Admin/Store/AllStores/Update/Done')}}">
                            <input type="hidden" value="{{csrf_token()}}" name="_token"/>
                            <input type="hidden" value="{{$post->id}}" name="id"/>
                            <div class="form-group">
                                <label for="exampleInputUsername1">{{__('all_strings.title')}}</label>
                                <input type="text" class="form-control" id="exampleInputUsername1" placeholder="{{__('all_strings.title')}}" name="title" value="{{$post->title}}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$post->price}}" type="number" class="form-control" id="exampleInputUsername1" placeholder="{{__('all_strings.price')}}" name="price" required>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputUsername1">{{__('all_strings.discount')}}</label>
                                <input value="{{$post->discount}}" type="number" class="form-control" id="exampleInputUsername1" placeholder="{{__('all_strings.discount_hint')}}" name="discount" required>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select onchange="onchnage_store_type(this)" id="store_type_combo" class="form-control" placeholder="{{__('all_strings.image_addrs')}}" name="type">
                                        @if($post->type=="FILE")
                                            ...
                                            <option selected value="FILE">{{__('all_strings.file')}}</option>
                                        @else
                                            <option selected value="PRODUCT">{{__('all_strings.product')}}</option>
                                ...
                                <div>
                                    ...
                                    <div id="uploaded_image_box" style="display: flex;">
                                        @foreach ($images as $image)
                                            <div class='preview_upload_imgae_div'><btn onclick="remove_store_image(this,'{{$image->id}}')" class='preview_upload_imgae_btn'><i class='mdi mdi-delete'></i></btn><img width='250px' src='/File/{{$image->file_hash}}'/></div>
                                        @endforeach
                                    </div>
                                    ...
                                    foreach ($images as $image)
                                    {
                                        $images_text.=$image->id.",";
                                    }


                                    ?>

                                    <input type="hidden" id="store_photos" value="{{$images_text}}" name="all_images"/>
                            ...
                            <div style="display: none;">
                                <div class="form-group">
                                    <label for="exampleInputUsername1">{{__('all_strings.newattr')}}</label>
                                    <div style="display: flex;">
                                ...
                                <input value="{{$post->json}}" name="attr" type="hidden" style="margin: 5px" class="form-control" id="attr_input" placeholder="{{__('all_strings.imageaddress')}}" value="[]">
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <label style="width: 100%;text-align: right;" for="exampleInputUsername1">{{__('all_strings.ditales')}}</label>
                                <textarea style="height: 150px;" class="form-control" id="exampleInputUsername1" name="cntent">{{$post->content}}</textarea>
                            </div>
