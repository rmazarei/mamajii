...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form enctype="multipart/form-data" class="forms-sample" method="post" action="{{url('/Admin/AllPosts/Update/Done')}}">
                        <input type="hidden" value="{{csrf_token()}}" name="_token"/>
                        <input type="hidden" value="{{$post->id}}" name="id" required/>
                        <div class="form-group">
                            <label for="exampleInputUsername1">{{__('all_strings.title')}}</label>
                            <input value="{{$post->title}}" type="text" class="form-control" id="exampleInputUsername1" placeholder="{{__('all_strings.title')}}" name="title" readonly>
                        </div>
                        ...
                        <div class="form-group" style="display: none;">
                            ...
                            <input value="{{$post->image}}" type="text" class="form-control" id="exampleInputUsername1" placeholder="{{__('all_strings.image_addrs')}}" name="img_adrs" required>
                        </div>
