    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="post" action="{{url('/Admin/Store/CatStore/New')}}">
                            ...
                            @if(isset(request()->id))
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{$edit_cat->icon_address}}" type="text" class="form-control" id="exampleInputUsername1" placeholder="{{__('all_strings.iconaddress')}}" name="iconaddress">
                                </div>
                                <div class="form-group">
                            ...
                            @else
                                ...
                                <div class="form-group">
                                    <label for="exampleInputUsername1">{{__('all_strings.iconaddress')}}</label>
                                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="{{__('all_strings.iconaddress')}}" name="iconaddress">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername1">{{__('all_strings.subcat')}}</label>
                                    <select class="form-control" id="exampleInputUsername1" name="root">
                        ...
                        <table class="table">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td><a href="{{url('/Admin/Store/CatStore/Update')}}/{{$category->id}}"><i class="mdi mdi-table-edit" style="color: #F00;font-size: 20px;"></i></a></td>
                                    <td><a href="{{url('/Admin/Store/CatStore/Remove')}}/{{$category->id}}"><i class="mdi mdi-delete" style="color: #F00;font-size: 20px;"></i></a></td>
